...
constexpr const constexpr_string s_1 = constexpr_string("Hello") + constexpr_string(", ") + constexpr_string("world!");
constexpr const constexpr_string s_2 = constexpr_string("Hello, world!");
constexpr const constexpr_string s_3 = constexpr_string("Bello, world!");
constexpr const constexpr_string s_4 = constexpr_string("Hello, world! With more stuff on the end");

constexpr const std::string S_1 = std::string("Hello") + std::string(", ") + std::string("world!");
constexpr const char *S_2 = "Hello, world!";
constexpr const char *S_3 = "Bello, world!";
constexpr const char *S_4 = "Hello, world! With more stuff on the end";
